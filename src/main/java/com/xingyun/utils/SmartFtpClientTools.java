...
public class SmartFtpClientTools {
	...
	private static final String REMOTE_SERVER_IP="192.168.123.101";
	...
	private static final String USER_PASSWORD="suhao-11";
	private static Logger log = LogManager.getLogger(SmartFtpClientTools.class);
