...
public final class SmartSftpUtils {
	private static Logger log = LogManager.getLogger(SmartSftpUtils.class);

	public static void main(String[] args) {

		SmartSftpUtils.downloadFileBySftp("192.168.123.101" ,"charles","suhao-11","sshdata/test.txt","./");
	}
